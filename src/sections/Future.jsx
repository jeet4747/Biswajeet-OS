...
import { Compass, MapPin, Target } from 'lucide-react';
    ...
    <Section id="future">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
         ...
         <div className="glass-card p-8 border-white/5 relative overflow-hidden group hover:border-electric/50 transition-colors">
            <div className="absolute -right-4 -top-4 w-24 h-24 bg-electric/10 rounded-full blur-2xl group-hover:bg-electric/20" />
            <MapPin className="text-electric mb-4" size={32} />
            <h3 className="text-2xl font-bold uppercase tracking-wide mb-2 text-white">Relocation Vector</h3>
            <div className="flex items-center gap-3 font-mono text-lg text-gray-300 mb-4">
               <span className="line-through text-gray-600">Pune</span>
               <span className="text-electric">→</span>
               <span className="font-bold text-white text-glow">Bangalore</span>
            </div>
            <p className="text-gray-400 text-sm">
               Transitioning base of operations to India's tech capital to plug into higher-density networks and scaled startups.
            </p>
         </div>
         ...
         <div className="glass-card p-8 border-white/5 relative overflow-hidden group hover:border-neon/50 transition-colors bg-gradient-to-br from-space to-neon/5">
            <div className="absolute -left-4 -bottom-4 w-24 h-24 bg-neon/10 rounded-full blur-2xl group-hover:bg-neon/20" />
